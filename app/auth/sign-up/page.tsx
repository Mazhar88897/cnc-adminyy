    ...
    <div className='m-5'>
      <div className="flex justify-center items-center flex-1 mt-2">
        <div className="w-full max-w-md border border-white rounded-mid p-6">
          <h2 className="text-white text-xl font-bold mb-1">Create and OnlyCNCs account
         </h2>
          <p className="text-white font-semibold text-sm mb-6"> Fill in the detials below and sign up.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block rounded-mid font-bold text-white mb-1">
                Confirm Password:
              </label>
              <Input
                id="confirmPassword"
            ...
            <div className="flex px-1 justify-between text-sm ">
              <Link href="/main/terms" className="text-white text-xs">
